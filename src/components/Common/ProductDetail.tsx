...
const ProductDetail: React.FC<ProductDetailProps> = ({ product }) => {
  ...
  // Función para abrir el slider de imágenes
  ...
  return (
    <>
    <Breadcrumb title={"Detalle del producto"} pages={["shop"]} />
    <section className="overflow-hidden py-20 bg-gray-50">
    <div className="flex items-center justify-center border-b border-gray-100 pb-5 mb-5">
    <div className="w-full max-w-[1100px] rounded-xl shadow-9 bg-white p-7.5 relative grid-cols-2 grid gap-10">
